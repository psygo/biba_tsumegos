...
\newcommand{\drawStoneFromSgfCoords}[2]{%
  ...
  \draw[draw = \UseName{not#1}, fill = #1, line width = 0.2mm]
    (\x * \step, \y * \step)
...
\def\sgfA{(;GM[1]FF[4]CA[UTF-8]AP[Sabaki:0.52.2]KM[6.5]SZ[19]DT[2024-10-15]PL[B]AE[pe][qe][pc][oc][qd][od];B[qd];W[od];B[oc];W[pd];B[pc];W[qe];B[nd];W[qc];B[rd];W[qb];B[re];W[qf];B[pb];W[nc];B[nb];W[mc];B[ne];W[of];B[mb];W[lc];B[lb];W[pa];B[ob];W[rc];B[rf];W[qg];B[rg];W[rh];B[qh];W[ri];B[qi];W[qj])}
