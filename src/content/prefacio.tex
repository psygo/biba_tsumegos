...
Há 3 pilares para se aprimorar no Go, qual seja o seu nível, desde iniciante até campeão mundial: jogar, revisar e praticar \emph{tsumego}. Caso o leitor não os conheça, tsumegos são problemas isolados ou localizados no jogo de Go.
