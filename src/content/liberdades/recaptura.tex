...
\problemAnswerDiagram[%
  ...
  answer text one = {\emph{Correto.} Preto captura, e, depois, Branco pode recapturar. De todo modo, o grupo branco é capturado. É, em essência, um corrida de captura do tipo ``\gls{olho vs sem olho}'', o que veremos mais à frente. Se houver um ataque severo contra A mais à frente, recapturar em 2 para Branco pode forçar uma outra corrida entretanto.},
