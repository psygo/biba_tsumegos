...
\problemAnswerDiagram[%
  ...
  problem text    = {Esta é uma variação um pouco rara de um dos josekis mais complexos do Go atual. Como proceder?},
  answer text one = {\emph{Correto.} Preto deveria espremer as pedras de corte brancas, minimizando o canto e dificultando a forma branca.},
