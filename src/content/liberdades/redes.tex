...
\problemAnswerDiagram[%
  ...
  answer text two = {\emph{Incorreto.} Branco pode escapar. Não é um desastre tão grande pois escapar com 2 leva a um ``squeeze'' ou ``espremida'', isto é, Preto sacrifica suas pedras para obter uma força bastante considerável no exterior. Escapar com A gera uma espremida pior para Branco, após Preto B.},
]
