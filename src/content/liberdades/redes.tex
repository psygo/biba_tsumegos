...
\problemAnswerDiagram[%
  ...
  problem text    = {Uma técnica de fim de jogo de grande utilidade. Estas leituras de primeira vs segunda linhas podem ser bastante desafiadoras até mesmo para jogadores muito avançados.},
...
\problemAnswerDiagram[%
  ...
  answer text one = {\emph{Correto.} É possível capturar a pedra de corte com uma rede após um primeiro atari. Branco não deveria tentar escapar com a pedra, dado que não funciona. Branco jogaria em A para salvar as pedras do canto e manter a iniciativa.},
...
\problemAnswerDiagram[%
  ...
  problem text             = {Um momento crítico na partida. Quando algo assim aparece em partidas, é o momento de utilizar o tempo no relógio.},
...
\problemAnswerDiagram[%
  ...
  problem text             = {Esta é uma variação do joseki ``Pequena Avalanche'', um dos josekis mais complexos do Go. Se Branco possui a escada, pode estender em 12. Branco 28 a 32 foram erros enormes, como punir?},
  ...
  answer text two          = {\emph{Incorreto.} Preto 1 parece criar uma ameaça de ambos os lados, no entanto, há um ko no canto a ser resolvido. Branco nem sequer precisa disparar o ko imediatamente com 4, jogar 4 em A é o suficiente.},
