...
\problemAnswerDiagram[%
  ...
  answer text one = {\emph{Correto.} Com um sacrifício, forçamos Branco a se colocar em atari. Esta técnica, em que sacrificamos uma pedra para deixar o adversário imediatamente em atari, é chamada de ``\gls{snapback}'' em inglês, o que pode ser traduzido talvez como ``ricochete'' em português.},
  answer text two = {\emph{Continuação.} Em seguida, capturamos diretamente. Tipicamente, esta técnica é tão potente que Branco deveria ter provavelmente jogado em A ao invés de B, caso B tenha sido a última jogada branca antes de A.},
]
