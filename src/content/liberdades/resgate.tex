...
\problemAnswerDiagram[%
  ...
  problem text    = {Há mais de um grupo preto sob \emph{\gls{atari}} --- atari é o termo para um grupo que está com somente 1 liberdade, e a inspiração para o console de videogame. Como melhorar a situação?},
...
\problemAnswerDiagram[%
  ...
  answer text one = {\emph{Correto.} Branco não consegue jogar em A diretamente pois seria \gls{auto-atari}. E outras tentativas também não funcionam.},
...
\problemAnswerDiagram[%
  ...
  answer text two = {\emph{Variação.} Preto pode também capturar o ko no canto, mas, no final, vai precisar voltar e jogar em A inevitavelmente. Branco pode seguir a partida normalmente, jogando um movimento qualquer no tabuleiro, e voltar para capturar o ko em B.},
]
...
\problemAnswerDiagram[%
  ...
  answer text two          = {\emph{Incorreto.} Branco captura a pedra que importa, e Preto não possui espaço suficiente para viver à direita ou ganhar alguma corrida de liberdades.},
