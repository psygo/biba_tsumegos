...
\problemAnswerDiagram[%
  ...
  answer text one = {\emph{Correto.} Este é um \gls{duplo-ko}. Não é possível capturar Preto pois há duas opções de captura em 1 e 5, para uma liberdade extra. Kos duplos são conhecidos como ``fábricas de ameaças'', pois Branco pode sempre efetuar uma captura interna como ameaça de um outro ko.},
