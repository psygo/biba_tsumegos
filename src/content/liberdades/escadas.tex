...
\problemAnswerDiagram[%
  ...
  answer text one = {\emph{Correto.} O melhor que Preto pode fazer em uma situação destas, localmente, é um compromisso ou negociação. Pedras adversárias que impossibilitam a escada são chamadas de ``quebra-escadas''.},
