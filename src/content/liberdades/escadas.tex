...
\problemAnswerDiagram[%
  ...
  answer text one = {\emph{Correto.} Este padrão é conhecido como \emph{\gls{shicho}} em japonês, ou ``escada'' em português. Ao chegar na borda do tabuleiro, Branco não conseguirá mais estender suas liberdades. Tanto A quanto B funcionarão para completar a captura quando chegamos a 1 linha da lateral.},
...
\problemAnswerDiagram[%
  ...
  answer text two = {\emph{Incorreto.} A escada ainda não funciona. A pedra branca A colocará a pedra preta 5 em atari inevitavelmente.},
]
