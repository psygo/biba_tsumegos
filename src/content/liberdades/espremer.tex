...
\problemAnswerDiagram[%
  ...
  problem text    = {Uma sequência muito avançada que surge às vezes após um joseki que caiu em desuso após o surgimento da inteligência artificial (IA).},
...
\problemAnswerDiagram[%
  ...
  problem text             = {Como diria Honinbo Shusai --- o último dos Honinbos, que dominaram o Go japonês entre os séculos \rom{16} e \rom{20} ---, Go é um jogo de cortes.},
...
\problemAnswerDiagram[%
  ...
  answer text one = {\emph{Correto.} Preto utiliza de uma escada frouxa e uma escassez de liberdades para capturar as pedras brancas.},
  answer text two = {\emph{Incorreto.} Isto parece funcionar, mas Preto possui fraquezas remanescentes no exterior. Se Branco não possuir a escada, pode optar por simplesmente capturar em Preto 15.},
]
...
\problemAnswerDiagram[%
  ...
  answer text one          = {\emph{Correto.} O warikomi de Preto 1 garante problemas de liberdades para Branco, não há muito para onde fugir. Esta é uma das versatilidades da forma marcada, que os franceses nomearam de ``escorpião''.},
...
\problemAnswerDiagram[%
  ...
  answer text one          = {\emph{Correto.} Preto 1 é contra-intuitivo para quem nunca viu algo assim pois é impossível salvar as outras pedras, mas isso pouco importa, pois a questão é a forma final branca, que é reduzida a ``bolinhos chineses''; ou ``cachos de uvas'', como diriam os coreanos.},
  answer text two          = {\emph{Incorreto.} Preto executa uma ideia parecida com a resposta, mas danificando menos a forma branca, que agora possui, no mínimo um olho, sem mencionar que Preto ficaria mais forte.},
  answer diagram clip vert = 10,
]
