...
\problemAnswerDiagram[%
  ...
  answer text one          = {\emph{Correto.} O warikomi de Preto 1 garante problemas de liberdades para Branco, não há muito para onde fugir, se Branco 2 em 5, Preto 2, e Branco colidirá com a parede preta à esquerda. Esta é uma das versatilidades da forma marcada, que os franceses nomearam de ``escorpião''.},
...
\problemAnswerDiagram[%
  ...
  answer text one          = {\emph{Correto.} Preto 1 é contra-intuitivo para quem nunca viu algo assim pois é impossível salvar as pedras brancas originais. Mas isso pouco importa, pois a questão é a forma final branca, que é reduzida a ``bolinhos chineses''; ou ``cachos de uvas'', como diriam os coreanos.},
