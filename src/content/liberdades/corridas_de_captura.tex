...
\problemAnswerDiagram[%
  ...
  answer text one = {\emph{Correto.} O princípio primordial é com certeza reduzir as liberdades por fora, isto é, pelas liberdades não mútuas dos grupos dentro corrida.},
...
\problemAnswerDiagram[%
  ...
  answer text two = {\emph{Incorreto.} Branco vive, salvando um grupo grande, enquanto Preto não ganha muita coisa localmente, no máximo, sente.},
]
...
\problemAnswerDiagram[%
  ...
  answer text two = {\emph{Incorreto.} Começar reduzindo as liberdades por for é um excelente princípio, mas não funcionará aqui.},
]
...
\problemAnswerDiagram[%
  ...
  problem text    = {Já estudamos este princípio, mas sua aplicação talvez seja um pouco mais difícil de se ver.},
...
\problemAnswerDiagram[%
  ...
  answer text one = {\emph{Correto.} Com um sacrifício, Preto faz com que Branco não consiga seu olho, aumentando drasticamente as chances de ganhar a corrida.},
