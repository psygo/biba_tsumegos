...
\problemAnswerDiagram[%
  ...
  answer text one = {\emph{Correto.} Preto captura as pedras brancas e, assim, depois da captura, possui mais de zero liberdades.},
...
\problemAnswerDiagram[%
  ...
  problem text    = {Esta posição é inspirada em um incidente em 2003, em que um dos maiores jogadores da história, o coreano Cho Hunhyun 9p, cometeu um erro raríssimo. É possível jogar em A?},
