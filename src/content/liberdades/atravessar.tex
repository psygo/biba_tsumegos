...
\problemAnswerDiagram[%
  ...
  answer text one          = {\emph{Correto.} Se Branco tentar salvar tudo, ficará com nada. Na verdade, a descida de A ajuda a criar mais problemas no canto com B, mas o erro de C foi demais, o dano com a pedra marcada foi excessivo.},
  answer text two          = {\emph{Variação.} Branco pode salvar o grupo à direita, mas o custo de um \gls{ponnuki} no exterior é demasiado grande.},
  answer diagram clip vert = 10,
]
