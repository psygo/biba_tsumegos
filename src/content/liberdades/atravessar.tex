...
\problemAnswerDiagram[%
  ...
  answer text two = {\emph{Variação.} Esta é uma das maneiras com que Branco poderia ter revertido para algo mais perto de parelho.},
]
...
\problemAnswerDiagram[%
  ...
  answer text one = {\emph{Correto.} Preto salva uma pedra, divide e pressiona os dois grupos brancos, e ainda reduz o território branco. Note que atravessamos o \gls{keima} branco.},
...
\problemAnswerDiagram[%
  ...
  answer text one          = {\emph{Correto.} Preto pode se conectar com uma das pedras do grupo, A ou B, e, assim, atravessar a forma branca completamente. Preto C é um tesuji muito útil quando queremos fugir de cercos. Para Branco, vale relembrar a máxima de que, se algo não funciona, é melhor nem tentar.},
...
\problemAnswerDiagram[%
  ...
  problem text             = {Branco tenta salvar uma pedra para minimizar o território preto na região e criar algum problema futuro no canto, depois do erro de 1. Mas é um pouco demais ainda. Como puni-lo?},
  answer text one          = {\emph{Correto.} Se Branco tentar salvar tudo, ficará com nada. Na verdade, a descida de A ajuda a criar mais problemas no canto com B, mas o erro de C foi demais, o dano com a pedra marcada foi excessivo. Não responder em 2 para resgatar as pedras com D geraria um \gls{ponnuki} excelente.},
  answer text two          = {\emph{Incorreto.} É possível capturar as pedras à direita, mas o atari no exterior é um benefício enorme para Branco, é um erro da mesma magnitude de A em essência, Preto é espremido. Dependendo do exterior, Branco pode optar por B, C ou D em seguida.},
  answer diagram clip vert = 10,
]
...
\problemAnswerDiagram[%
  ...
  answer text two = {\emph{Incorreto.} Uma resposta pre-ta passiva. Branco agora pode disparar um ko, ou simplesmente estender em 3 caso haja espaço para viver sem ko.},
]