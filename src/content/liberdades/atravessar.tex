...
\problemAnswerDiagram[%
  ...
  problem text    = {O contato em 3 é um joseki circunstancial, para o caso em que Branco queira se estabilizar rapidamente. É uma sequência que só passou a ser viável para Preto após a IA.},
  answer text one = {\emph{Correto.} Preto joga da maneira mais severa possível. Branco faz o atari de 4 se Preto não conseguir lutar o ko, que é imenso. A pedra preta marcada foi bastante danificada, mas ela pode ser resgatada com A, e o grupo inteiro Branco flutuará, instável.},
  answer text two = {\emph{Incorreto.} Uma resposta passiva. Branco agora pode disparar um ko, ou simplesmente estender em 2 caso haja espaço para viver sem ko.},
]
