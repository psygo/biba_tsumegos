...
\problemAnswerDiagram[%
  ...
  problem text    = {É possível capturar a pedra branca? (Em livros de tsumego, costuma-se padronizar sempre Preto a jogar.)},
...
\problemAnswerDiagram[%
  ...
  answer text two = {\emph{Variação.} Preto pode sempre fazer \emph{\gls{tenuki}}, isto é, ignorar movimentos locais e jogar em outro lugar, mas então será Branco quem poderá capturar a pedra preta.},
]
...
\problemAnswerDiagram[%
  ...
  answer text one = {\emph{Correto.} A captura da pedra branca configura uma forma chamada \emph{\gls{ponnuki}}, que é o número mínimo de pedras para se capturar uma pedra adversária, quando ela não está nem no extremo canto ou extrema borda.},
...
\problemAnswerDiagram[%
  ...
  answer text two = {\emph{Incorreto.} Preto poderia ter capturado a pedra branca, o que sanaria o corte de uma maneira mais eficiente, evitando jogar em seu próprio território. E esta defesa dá chances para que Branco conecte todas as suas pedras mais tarde.},
]
...
\problemAnswerDiagram[%
  ...
  answer text two = {\emph{Variação.} Localmente pelo menos, não jogar aqui co-mo Preto ajuda o adversário a se estabilizar, enquanto contra-ataca severamente.},
]
...
\problemAnswerDiagram[%
  ...
  answer text one = {\emph{Correto.} Apesar de o grupo branco ter mais pedras, ele ainda possui somente 1 liberdade. Esta forma é conhecida como ``\gls{casco de tartaruga}'', que é o número mínimo de pedras necessário para se capturar 2 pedras.},
...
\problemAnswerDiagram[%
  ...
  answer text two = {\emph{Variação.} Branco reverte pa-ra uma captura para si, e o grupo preto agora está flutuando, instável, sem base.},
]
...
\problemAnswerDiagram[%
  ...
  answer text two = {\emph{Variação.} Se Branco quiser e puder, pode consertar o problema com 1 ou A. Branco 1 garante mais forma de olho, e Branco A, menos ameaças de ko, ambos são possíveis, a escolha dependerá do resto do tabuleiro.},
]