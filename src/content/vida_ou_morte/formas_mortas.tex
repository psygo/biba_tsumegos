...
\problemAnswerDiagram[%
  ...
  answer text one = {\emph{Correto.} Ao jogar 1, Preto impossibilita a separação do espaço de olho em dois. Se Branco jogasse em 1, estaria vivo.},
  answer text two = {\emph{Continuação.} Preto reduzirá o espaço de olho para uma forma morta de 3 pedras. Em japonês, o termo para forma morta é \emph{\gls{nakade}}.},
]
...
\problemAnswerDiagram[%
  ...
  problem text    = {Agora, chegamos a praticamente a última forma morta que aparece comumente em partidas e problemas de vida ou morte.},
  answer text one = {\emph{Correto.} Esta forma morta é chamada de ``\gls{bulky five}'' em inglês, ou ``cinco pesado'', ``cinco corpulento'', em português. Seu ponto fraco é Preto 1.},
...
\problemAnswerDiagram[%
  ...
  answer text one = {\emph{Correto.} Outro problema simétrico. E, em tais problemas, o eixo de simetria é mais uma vez um bom indício. Com 1, Preto bloqueia os dois lados do canto em boa forma.},
