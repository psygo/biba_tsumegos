...
\problemAnswerDiagram[%
  ...
  answer text two = {\emph{Incorreto.} Se Preto não jogar nada, Branco pode viver.},
]
...
\problemAnswerDiagram[%
  ...
  answer text one = {\emph{Correto.} Ao jogar 1, Preto impossibilita separar o espaço de olho em 2. (Se Branco jogasse em 1, estaria vivo.)},
...
\problemAnswerDiagram[%
  ...
  answer text one = {\emph{Correto.} No máximo, Bran-co conseguirá um olho grande de 2 ou 3 pedras.},
  answer text two = {\emph{Incorreto.} Agora, há 2 olhos.},
]

\problemAnswerDiagram[%
  sgf folder      = vida_ou_morte/formas_mortas,
  sgf filename    = formas_mortas.12,
  problem text    = {Preto consegue capturar o canto antes de ser capturado? Será que ele consegue até fazer tenuki? Se sim, quantos?},
...
\problemAnswerDiagram[%
  ...
  problem text    = {Agora, Branco possui um espaço vital de 4 ``quadrado''. É possível viver com este espaço?},
...
\problemAnswerDiagram[%
  ...
  answer text one = {\emph{Correto.} Não, não é possível fazer tenuki. Tanto o grupo preto quanto o canto branco possuem 3 liberdades, quem jogar primeiro, ganha. Preto 3 em A também funcionaria, assim como Preto 1 em 3, que é simétrico.},
...
\problemAnswerDiagram[%
  ...
  answer text one = {\emph{Correto.} Esta forma morta é chamada de ``bulky five'' em inglês, ou ``cinco pesado'', ou ``cinco corpulento'', em português. Seu ponto fraco é Preto 1.},
...
\problemAnswerDiagram[%
  ...
  answer text two = {\emph{Variação.} O ponto-chave para matar é o também o de viver.},
]
