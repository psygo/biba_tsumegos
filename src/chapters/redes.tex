...
\problemAnswerDiagram
  ...
  {\emph{Correto.} Não muda em nada em relação à rede do problema \textLmr{1}.}
...
\problemAnswerDiagram
  ...
  {\emph{Correto.} O grupo preto possui \textLmr{3} liberdades, o que é o suficiente para se garantir uma rede padrão.}
  {\emph{Incorreto.} No geral, \textLmr{1} é incorreto, pois acaba em uma escada que vai para o lado. Mas escadas indo para o lado podem ser ocasionalmente melhores do que uma rede.}

\problemAnswerDiagram
  {redes}
  {redes.5}
  {Esta já é uma rede bem mais avançada.}
  {\emph{Correto.} O importante é que Branco não vai conseguir mais de \textLmr{2} liberdades com a pedra de corte, o que é menos do que as pedras pretas que a cercam.}
  {\emph{Incorreto.} Às vezes, \textLmr{1} pode sera a rede ótima, mas, neste caso, Branco está muito forte no exterior.}