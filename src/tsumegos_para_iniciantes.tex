% TODO: Find out why labels are behaving weirdly (maybe reduce the problem to Segletes' example with only the triangle or text label)
% TODO: X Labels for the suicide problem
% TODO: Separate life and death under techniques: two eyes, false eyes, dead shapes, and sekis (and sacrifice to the liberties part)
% TODO: Add a note to the preface about the difficulty of this book
% TODO: Add a section to the preface explaining the structure of the book.
%-----------------------------------------------------------
% Document Configs
