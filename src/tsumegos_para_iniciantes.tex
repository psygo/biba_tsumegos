% TODO: Better TOC colors
% TODO: Put the TOC on only 1 page
% TODO: Add a comment to the preface about the fact that it will take a little bit for the patterns of the game to seep into the reader's brain.
% TODO: Consider making a 3rd part for "random" exercises. (Although maybe this should be more for 101weiqi...)
% TODO: Add these 2 problems to the end of the ladder chapter:
%       - https://www.101weiqi.com/mytag/ladder/40697/
%       - https://www.101weiqi.com/mytag/ladder/22883/
%-----------------------------------------------------------
% Document Configs
